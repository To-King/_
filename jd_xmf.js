...
let PandaToken = '';
let jdLogsArr=[];
PandaToken = $.isNode() ? (process.env.PandaToken ? process.env.PandaToken : `${PandaToken}`) : ($.getdata('PandaToken') ? $.getdata('PandaToken') : `${PandaToken}`);
// if (!PandaToken && !RabbitUrl){
