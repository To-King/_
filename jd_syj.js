...
!(async () => {
  ...
  $.authorTuanList = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_zz.json');
  if (!$.authorTuanList) {
  ...
  const temp = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_zz.json') || []
