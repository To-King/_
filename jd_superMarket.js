  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        await updatePkActivityIdCDN('https://cdn.jsdelivr.net/gh/To-King/Profiles/shareCodes/jd_updateTeam.json');
...
//新版东东超市
function updatePkActivityId(url = 'https://cdn.jsdelivr.net/gh/To-King/Profiles/shareCodes/jd_updateTeam.json') {
  return new Promise(resolve => {
...
async function barGain() {
  let res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/To-King/Profiles/shareCodes/jd_updateTeam.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/To-King/Profiles/shareCodes/jd_updateTeam.json')
  }
