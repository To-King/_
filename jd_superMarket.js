  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        await updatePkActivityIdCDN('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_updateTeam.json');
...
//新版东东超市
function updatePkActivityId(url = 'https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_updateTeam.json') {
  return new Promise(resolve => {
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/bigWinner.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode2('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/bigWinner.json')
  }
