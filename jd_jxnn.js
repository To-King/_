...
!(async () => {
    ...
    const author = Math.random() > 0.5 ? 'ugg999999' : 'ugg999999'
...
function getShareCode(name, author = 'ugg999999', num = -1, shuffle = false) {
    return new Promise(resolve => {
        $.get({
            //变量修改助力码
            url: `https://raw.fastgit.org/${author}/Profiles/master/shareCodes/${name}`,
            headers: {
