...
function openCardActivity(activityId, activityUrl, pin, num, againUserIndex) {
  return new Promise((resolve) => {
    ...
    if (process.env.jd_zdjr_activityId_wdz)
      activityId = process.env.jd_zdjr_activityId_wdz;
    if (process.env.jd_zdjr_activityUrl_wdz)
      activityUrl = process.env.jd_zdjr_activityUrl_wdz;
