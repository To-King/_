...
//   await $.wait(1000)
  await updateShareCodesCDN('https://cdn.jsdelivr.net/gh/ugg999999/Profiles/master/shareCodes/jd_shareCodes.json')
  await $.wait(1000)
  await getShareCode()
...
function getShareCode() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/jd_shareCodes.json",
      headers: {
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      },
      "timeout": 10000
