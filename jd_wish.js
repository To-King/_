...
let appIdArr = ["1GVFUx6g", "1E1xZy6s"];
let appNameArr = ["JOY年味之旅","PLUS生活特权"];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/wish.json')
  if (!res) {
