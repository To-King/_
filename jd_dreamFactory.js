...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_updateFactoryTuanId.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await updateTuanIdsCDN('https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/jd_updateFactoryTuanId.json');
  }
