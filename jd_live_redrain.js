...
!(async () => {
  ...
  if (!($.st <= nowTs && nowTs < $.ed)) {
    ...
    if (!redIds) redIds = await getRedRainIds('https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/redrain.json');
    $.newAcids = [...(redIds || [])];
...
function getRedRainIds(url = "https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/redrain.json") {
